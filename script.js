...
const quickLoadDriveData = document.querySelector("#quickLoadDriveData");
const mobileQuickLoadDriveData = document.querySelector("#mobileQuickLoadDriveData");
...
quickLoadDriveData.addEventListener("click", loadDataFromDrive);
mobileQuickLoadDriveData.addEventListener("click", loadDataFromDrive);
...
function applyRoleUi() {
  ...
  setActionVisible("#quickLoadDriveData", can("drive.load") || can("all"));
  setActionVisible("#mobileQuickLoadDriveData", can("drive.load") || can("all"));
